...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: "Go-Nav", link: "/go-nav/", activeMatch: "^/go-nav/" },
      ...
      "/go-nav/": [
        {
          ...
          items: [
            { text: "总览", link: "/go-nav/" },
            { text: "安装部署", link: "/go-nav/install" },
            { text: "后台功能说明", link: "/go-nav/admin" },
            { text: "站点配置说明", link: "/go-nav/site-config" },
            { text: "MCP", link: "/go-nav/api" },
          ],
        },
      ],
      "/pansearch/": [
      ...
      "/reman/": [
        ...
        },
        {
          ...
          items: [
            ...
            // { text: '插件大全说明', link: '/reman/plugins' },
